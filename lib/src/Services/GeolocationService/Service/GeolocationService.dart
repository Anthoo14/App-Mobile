...
abstract class GeolocationFailureMessage{
  //ERROR MESSAGE
  static String locationServiceDisabled =
...
extension PrivateMethods on DefaultGeolocationService{
  ...
  Future<Position> _determinePosition() async {
    ...
    if (!serviceEnabled) {
      ...
      return Future.error(GeolocationFailureMessage.locationServiceDisabled);
    }
    ...
    if (permission == LocationPermission.deniedForever) {
      ...
      return Future.error(
          GeolocationFailureMessage.locationPermissionsDeniedForever);
    }
