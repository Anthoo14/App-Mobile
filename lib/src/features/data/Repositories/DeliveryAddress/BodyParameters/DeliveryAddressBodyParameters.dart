...
class DeliveryAddressListBodyParameters {
  ...
  factory DeliveryAddressListBodyParameters.fromMap(Map<String, dynamic> json) {
    return DeliveryAddressListBodyParameters(
      deliveryAddressList: List<DeliveryAddressBodyParameters>.from(json['deliveryAddressList'].map((address) => DeliveryAddressBodyParameters.fromMap(address))),
    );
  }
...
class DeliveryAddressBodyParameters {
  ...
  factory DeliveryAddressBodyParameters.fromMap(Map<String, dynamic> json) => DeliveryAddressBodyParameters(
    id: json["id"],
