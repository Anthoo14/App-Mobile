...
class PlaceListDecodable {
    ...
    factory PlaceListDecodable.fromMap(Map<String, dynamic> json) => PlaceListDecodable(
        placeList: json["placeList"] == null ? null : List<PlaceDetailDecodable>.from(json["placeList"].map((x) => PlaceDetailDecodable.fromMap(x))),
    );
...
class PlaceDetailDecodable {
    ...
    factory PlaceDetailDecodable.fromMap(Map<String, dynamic> json) => PlaceDetailDecodable(
        address: json["address"] ?? "",
        adminId: json["adminId"] ?? "",
        averageDelivery: json["averageDelivery"] ?? "",
        averagePrice: json["averagePrice"] ?? 0,
        categories: json["categories"] == null ? [] : List<PlaceCategoryDecodable>.from(json["categories"]!.map((x) => PlaceCategoryDecodable.fromJson(x))), 
        city: json["city"] ?? "",
        collectionId: json["collectionId"] ?? 0,
        country: json["country"] ?? "",
        description: json["description"] ?? "",
        email: json["email"] ?? "",
        favourites: json["favourites"] == null ? [] : List<String>.from(json["favourites"].map((x) => x)),
        ...
        placeRatings: json["placeRatings"] == null ? [] : List<PlaceRatingDecodable>.from(json["placeRatings"]!.map((x) => PlaceRatingDecodable.fromJson(x)))  
    );
...
class PlaceCategoryDecodable {
    ...
    factory PlaceCategoryDecodable.fromJson(Map<String, dynamic> json) => PlaceCategoryDecodable(
...
class PlaceProductDecodable {
    ...
    factory PlaceProductDecodable.fromJson(Map<String, dynamic> json) => PlaceProductDecodable(
        amount: json["amount"],
        id: json["id"],
        ...
        options: json["options"] == null ? [] : List<PlaceProductExtras>.from(json["options"]!.map((x) => PlaceProductExtras.fromJson(x))),
    );
...
class PlaceProductExtras {
    ...
    factory PlaceProductExtras.fromJson(Map<String, dynamic> json) => PlaceProductExtras(
        id: json["id"],
        extras: json["extras"] == null ? [] : List<PlaceProductExtra>.from(json["extras"].map((x) => PlaceProductExtra.fromJson(x))),
...
class PlaceProductExtra {
    ...
    factory PlaceProductExtra.fromJson(Map<String, dynamic> json) => PlaceProductExtra(
        id: json["id"],
...
class PlaceRatingDecodable {
    ...
    factory PlaceRatingDecodable.fromJson(Map<String, dynamic> json) => PlaceRatingDecodable(
        userId: json["userId"],
